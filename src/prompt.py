...
oer_agent_prompt = f"""
            ...
            <Requirements>:
                ...
                14. Keeping the queue busy is a consequence of staying on top of your analysis and launching the work it reveals, not a target to chase for its own sake. Use any time before waiting to advance the study: analyze finished results and launch the follow-up calculations they justify.
